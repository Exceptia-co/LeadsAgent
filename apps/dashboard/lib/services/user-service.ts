...
export class UserService {
   ...
   */
  static async updateUser(clerkId: string, updateData: UpdateUserData): Promise<UnifiedUser | null> {
    try {
      const updates: any = {
      ...
      if (updateData.profileImageUrl !== undefined) updates.profile_image_url = updateData.profileImageUrl
      ...
      console.log('✅ User updated successfully:', { clerkId, fields: Object.keys(updates) })
