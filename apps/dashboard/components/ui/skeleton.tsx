...
export function SkeletonTabs({ tabCount = 6, className = '' }: { tabCount?: number; className?: string }) {
  return (
...
export function SkeletonSessionGrid({ count = 6, className = '' }: { count?: number; className?: string }) {
  return (
