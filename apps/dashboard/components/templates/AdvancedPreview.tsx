        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pl-8 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {/* Selected Lead Info */}
              {selectedLead && (
                <Card className="p-4 bg-gradient-to-r from-green-50 to-indigo-50 border-green-200">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    {previewLoading ? (
                      ...
                      <div className="bg-green-100 p-3 rounded-lg max-w-sm ml-auto">
                        <pre className="whitespace-pre-wrap text-sm text-gray-800">
                          {previewContent ||
                            templateContent ||
                            "Contenido del mensaje aparecerá aquí..."}
                        </pre>
                      </div>
                    )}
                  </div>
