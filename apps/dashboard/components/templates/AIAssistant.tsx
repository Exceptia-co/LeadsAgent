  ...
  const categories = [
    {
      id: "welcome",
      label: "Bienvenida",
      description: "Mensajes de presentación y primer contacto",
    },
    {
      id: "products",
      label: "Productos",
      description: "Información sobre servicios y productos",
    },
    {
      id: "pricing",
      label: "Precios",
      description: "Información de precios y paquetes",
    },
    {
      id: "follow_up",
      label: "Seguimiento",
      description: "Mensajes de seguimiento post-contacto",
    },
    {
      id: "support",
      label: "Soporte",
  ...
  const lengths = [
    {
      id: "corto",
      label: "Corto",
      description: "1-2 párrafos (30-50 palabras)",
    },
    {
      id: "medio",
      label: "Medio",
      description: "2-3 párrafos (50-100 palabras)",
    },
    {
      id: "largo",
      label: "Largo",
      description: "3-4 párrafos (100+ palabras)",
    },
  ];
              ...
              {!generating && !error && (
                <>
                  <div className="max-w-md mx-auto">
                    <div className="p-6 bg-gradient-to-r from-purple-50 to-green-50 rounded-lg border">
                      ...
                      <div className="text-left space-y-2 text-sm">
                        ...
                        <div>
                          ...
                          {lengths.find((l) => l.id === formData.length)?.label}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center space-x-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-gradient-to-r from-purple-600 to-green-600 text-white rounded-lg hover:from-purple-700 hover:to-green-700 flex items-center"
                    >
            ...
            <div className="space-y-6">
                    ...
                    <div className="bg-white border rounded-lg p-4 text-sm space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {generatedResult.metadata?.aiProvider || "openrouter"}
                        </span>
                      </div>
              ...
              <div className="flex justify-between items-center pt-4 border-t">
                <button
                  onClick={() => handleGenerate()}
                  disabled={generating}
                  className="px-4 py-2 text-green-600 border border-green-300 rounded-lg hover:bg-green-50 flex items-center"
                >
