        ...
        <div className="flex flex-wrap gap-2">
          {getAllVariables().map((variable) => (
            <button
              ...
              className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-green-50 text-green-700 hover:bg-green-100 transition-colors border border-green-200"
