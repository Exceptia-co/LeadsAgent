      ...
      <div className="space-y-6">
        ...
        <Card className="p-4">
          <div className="text-center">
            ...
            <h4 className="text-sm font-medium text-gray-900 mb-1">Error al cargar conversaciones</h4>
        ...
        <Card className="p-3">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-lg font-semibold text-gray-900">{Math.round(stats.averageTokens)}</p>
            </div>
          </div>
        </Card>
      </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <div className="flex items-center space-x-2">
                        <Badge 
                          variant={conversation.lead.status === 'NUEVO' ? 'default' : 
                                  conversation.lead.status === 'QUALIFIED' ? 'default' : 'secondary'}
                          className="text-xs"
                        >
