      ...
      <div className="bg-white rounded-full shadow-2xl border border-gray-200 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 animate-in slide-in-from-bottom-2 fade-in duration-300">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center px-6 py-2 text-sm bg-green-600 text-white rounded-full hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-20"
          ...
          <button
            ...
            disabled={isLoading}
            className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-20"
