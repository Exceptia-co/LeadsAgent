        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="text-sm border-0 bg-transparent focus:ring-2 focus:ring-green-500 focus:ring-opacity-20 focus:outline-none cursor-pointer text-gray-700 font-medium rounded px-1 py-1"
