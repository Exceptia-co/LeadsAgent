...
export default function DashboardPage() {
  ...
  } = useLeads(1, 5, undefined, undefined, undefined, {
          ...
          <div className="flex items-center space-x-3">
            ...
            {(statsRefreshInterval > 0 || leadsRefreshInterval > 0) && (
              <div
                ...
                title="Intervalos de actualización automática"
              >
                Stats:{" "}
                {statsRefreshInterval > 0
                  ? `${Math.round(statsRefreshInterval / 1000 / 60)}min`
                  : "Manual"}{" "}
                | Leads:{" "}
                {leadsRefreshInterval > 0
                  ? `${Math.round(leadsRefreshInterval / 1000 / 60)}min`
                  : "Manual"}
              </div>
            )}
          </div>
