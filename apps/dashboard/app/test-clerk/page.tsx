    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-100 p-4 rounded">
          ...
          <p>Publishable Key Present: {process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY ? '✅ Yes' : '❌ No'}</p>
      ...
      <div className="mt-8">
        <a href="/sign-in" className="bg-blue-500 text-white px-4 py-2 rounded mr-4">
          Go to Sign In
        </a>
