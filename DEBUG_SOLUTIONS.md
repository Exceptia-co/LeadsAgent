...
DATABASE_URL="postgresql://postgres.PROJECT_REF_REMOVED:PASSWORD_REMOVED@aws-1-eu-west-3.pooler.supabase.com:6543/postgres"

# Después (packages/db/.env)
DATABASE_URL="postgresql://postgres:PASSWORD_REMOVED@db.PROJECT_REF_REMOVED.supabase.co:5432/postgres"
```
