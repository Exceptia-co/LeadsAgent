...
2. **Seleccionar tu proyecto:**
   - Busca y selecciona el proyecto con referencia: `yxjzsargboxnuwnbuzax`
...
2. **Ejemplo:**
   ...
   DATABASE_URL="postgresql://postgres.yxjzsargboxnuwnbuzax:mi_password_segura_123@aws-0-us-east-1.pooler.supabase.com:6543/postgres"
   DIRECT_URL="postgresql://postgres.yxjzsargboxnuwnbuzax:mi_password_segura_123@aws-0-us-east-1.compute-1.amazonaws.com:5432/postgres"
   ```
