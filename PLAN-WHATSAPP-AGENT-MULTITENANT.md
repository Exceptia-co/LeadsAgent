...
- **R1 — WhatsApp Business API oficial (Meta Cloud API)**: **CONDICIONADO, no planificado** (revisado 2026-08-25). Incompatible con el onboarding actual: el cliente conecta **su propio número** por QR, el que ya usa con sus contactos, y Cloud API exige número dedicado. Meta ofrece *Coexistence* vía Embedded Signup, que permite conservar número y app — pero solo para cuentas de **WhatsApp Business App**, no WhatsApp personal, con límites de elegibilidad por cuenta y región más verificación y App Review. **Reabrir solo si** se comprueba que los clientes usan Business App y son elegibles, o si el producto pasa a ofrecer número propio. La migración de escala que sí se ejecuta es a Baileys (ver cabecera).
