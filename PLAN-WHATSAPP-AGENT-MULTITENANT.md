...
- **Estado:** **Fase A desplegada + fix double-init mergeado + B1 PR1 foundation schema commiteado**. PR1 B1 schema está en `feature/b1-foundation-schema` (commit `364979a`) y es estrictamente additive-only: no se aplica a Supabase producción hasta coordinar PR1+PR2+PR3 con backfill.
